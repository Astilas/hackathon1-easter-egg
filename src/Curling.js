...
const CarouselCard1 = (props) => (
  ...
  Le curling est un sport officiel olympique en 1924 puis de nouveau à partir de 1998.
    ...
    <p className="white">
      Chasseurs dans la neige et Le Trébuchet sont des huiles sur bois du peintre flamand Pieter Brueghel l'Ancien. Les deux tableaux peints en 1565 montrent un jeu qui évoque le curling3, l'une sur un étang gelé, l'autre sur la rivière gelée, mais il n'y a pas encore les balais.
  ...
  Une particularité des pierres est que leur base n'est pas plate mais concave et la surface de glisse de la pierre est de 6 à 12 mm moins large que la largeur de la pierre. Cette petite différence permet de donner un effet à la pierre qui aura tendance à suivre une trajectoire courbée (les spécialistes disent qu'elle curle, de l'anglais to curl, courber). Le degré de curl dépend de plusieurs facteurs pendant le jeu, notamment de la vélocité imprimée à la pierre lors de son lancement, de la préparation de la glace perlée, du réchauffement des petits pitons glacés par balayage lors de sa glisse vers la maison. Les raisons physiques de cette trajectoire sont complexes et demeuraient jusqu'à récemment incomprises (lubrification par un film liquide ou frottement solide)12. Deux scientifiques canadiens ont cependant développé un modèle mathématique expliquant assez fidèlement la trajectoire des pierres, selon un principe de pivot et glissement
  Les Écossais, en particulier, estiment que les pierres de curling de la meilleure qualité sont faites à partir d'une variété spéciale de granite, l'ailsite, que l'on trouve sur l'Ailsa Craig, une île escarpée située à 16 km de la côte d'Ayrshire, au sud-ouest de l'Écosse. Cet ailsite est un micro-granite contenant de la <Link to="/game" className="white">riébeckite</Link> . En 2004, on estimait que 60 à 70 % de toutes les pierres de curling étaient faites de granite provenant de cette île. Une autre des principales sources pour les pierres de curling est la carrière de granite de Trefor dans le Pays de Galles.
</p>
    <h5>Équipement</h5>
    <p className="white">
    ...
    <h5>Dernière pierre</h5>
    <p className="white">
      La dernière pierre jouée est souvent surnommée le « marteau ». L'équipe qui a la dernière pierre lors du premier « end » de la partie est choisie au hasard par un tirage au sort, généralement un « pile ou face », ou par un tir de précision. À chaque « bout » gagnant, le dernier jet est attribué au perdant du « bout » précédent. Dans le cas où aucune équipe n'a gagné aucun « bout », le tour revient à nouveau à la même équipe que lors de cette partie sans score. Il est évidemment plus simple de gagner lorsque l'équipe a le dernier jet. Lors des tournois, l'équipe qui a le dernier jet essaye parfois de jouer pour deux points ou plus. Si seulement un point semble possible, le skip va alors tenter d'annuler le jeu en cours en ne faisant pas de point pour avoir le droit d'avoir à nouveau le dernier lancer sur le « bout » suivant. Lorsque cela arrive on appelle cela un jeu blanc. Gagner un point ou plus en n'ayant pas le dernier jeu est un « vol ».
</p>
    <h5>Discussion des résultats</h5>
    <p className="white">
    ...
    La France ne compte en 2012 que 350 licenciés. L’équipe masculine française a cependant participé aux Jeux de Salt Lake City en 2002 et à ceux de 2010 à Vancouver, où elle se classe 7e nation mondiale.
  </p>
    <h3>Compétitions</h3>
    <h5>Jeux olympiques</h5>
    <p className="white">
    ...
    Lors des Jeux de 1998 à Nagano, le curling redevient sport olympique, la Suisse remportant le titre chez les hommes devant la Norvège et les États-Unis, le Canada remportant le premier titre olympique chez les femmes, devant le Danemark et la Suède. L'édition suivante en 2002 à Salt Lake City voit la Norvège s'imposer chez les hommes, la Grande-Bretagne remportant le titre féminin. En 2006 à Turin, le Canada s'impose chez les hommes, la Suède remportant le titre féminin. Ces deux nations se succèdent à elle-même lors des Jeux de 2010 à Vancouver. En 2014 à Sotchi, le Canada remporte un troisième titre consécutif, l'équipe féminine canadienne privant la Suède d'un troisième titre en finale. L'édition 2018 voit les États-Unis s'imposer chez les hommes, la Suède renouant avec le titre olympique chez les femmes. Le double mixte figure pour la première fois au programme olympique lors de cette édition, le Canada s'imposant devant la Suisse et la Norvège.
    ...
    <p className="white">
      ...
      En 1979, apparaissent les championnats du monde de curling féminin. Les curleuses disputent annuellement un championnat du monde de curling féminin en un lieu et à une date parfois identique et parfois distincte de ceux du championnat du monde masculin, également annuel.
</p>
    <h5>Autres compétitions internationales</h5>
    <p className="white">- Championnats d'Europe de curling</p>
    <p className="white">- Créés en 2004, se déroulent tous les ans.</p>
